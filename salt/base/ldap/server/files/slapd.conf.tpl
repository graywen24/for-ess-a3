...
# TLS setup
# security ssf=128
TLSCACertificateFile {{ pillar.system.ssldir }}/{{ pillar.ldap.cafile }}
TLSCertificateFile {{ pillar.system.ssldir }}/certs/{{ pillar.ldap.cert }}.crt
TLSCertificateKeyFile {{ pillar.system.ssldir }}/private/{{ pillar.ldap.cert }}.key
...
{%- else %}
{% macro get_masterip() -%}
{%- for key, serverinfo in pillar.ldap['servers'].iteritems() -%}
